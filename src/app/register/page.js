    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex items-center justify-center w-1/2 p-12">
        <div className="text-main-text text-left"> 
          <div className="semibold-64 mb-0">📝 Register</div> 
          <p className="regular-16 mb-8">Take the first step towards bahasa Indonesia.</p> 
          ...
          <form className="flex flex-col space-y-4 mt-4 mb-20"> 
            ...
            <div className="flex justify-between">
                <Button linkPage="/login" title="Login" type="small-secondary" />
                <Button linkPage="/login" title="Register" type="small" />
            </div>
          </form>
        </div>
      </div>
