    ...
    return (
        <div className="flex min-h-screen flex-col p-24">
            ...
            <div className="flex flex-row pt-16 justify-center">
                {/* <CardVertical linkPage="" image={ word } title="Level 1.0" description="Put your speaking skills to the test!"/> */}
                {/* <CardVertical linkPage='' image={ word } title="Level 2.0" description="Put your speaking skills to the test!"/> */}
            </div>
            <div className="flex flex-row pt-16 justify-center">
